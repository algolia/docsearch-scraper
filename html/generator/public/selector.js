...
document.write('<style>.algolia-hover.algolia-deepest { outline: 1px solid red !important; cursor: pointer; }</style>');
...
$(document).on('mouseout', SELECTOR, function() {
  $(this).removeClass('algolia-hover').removeClass('algolia-deepest');
});
